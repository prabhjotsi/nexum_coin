...
body{
    height: 100%;max-height: unset;background: url('images/1267580.jpg');
}
.form-custom>span{
    color:black;
    font-weight:600;
...
<body class="theme-light" style="
    height: 100%;
    max-height: unset;
    background: url('images/1267580.jpg');
">
    <div id="preloader">
    ...
    <div id="page">
        ...
        <div class="page-content footer-clear">
            ...
            <div class="card-center mt-5 mx-3 px-4 py-4  rounded-m" style="background:white">
                <img src="images/nxm_logo.svg" style="border-radius: 13px;width:130px" />
                <h1 class="font-10 font-800 mb-0">Nexum Coin</h1>
                                 <form action="https://www.nexumcoins.com/register/details" method="POST">
        ...
        document.getElementById("inviteCode").value="NXM000000";
                    ...
                    <div class="col-6 ">
                     ...
                     <div class="col-6 text-center">
                        <a href="login.html" class="font-11 color-theme  pt-4 d-block"><span>Sign In Account</span></a>
                    </div>
                </div>
      </form>
            </div>
